...
async def play(_, message: Message):
    ...
    lel = await message.reply("**جاري التحميل انتظر يعم 🏃‍♂️🏃‍♂️.. **")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/742c050a8609e57a8fd94.jpg"
        ...
        # print(query)
        await lel.edit("**جاري التحميل يعم اصبر شويه 🏃‍♂️🏃‍♂️.. **")
        try:
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/742c050a8609e57a8fd94.jpg", 
                             caption="**⚡𝙨𝙤𝙪𝙧𝙘𝙚 𝙩𝙞𝙩𝙤⚡ ᴍᴜꜱɪᴄ\n ɴᴏᴡ ▶️ ᴘᴀᴜꜱᴇᴅ ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALL:
        await message.reply_text("**⚡𝙨𝙤𝙪𝙧𝙘𝙚 𝙩𝙞𝙩𝙤⚡ ᴍᴜꜱɪᴄ \n ɴᴏᴛʜɪɴɢ ᴘʟᴀʏɪɴɢ ...**")
    else:

...
io.popen("cd File_Bot && wget https://github.com/Gambol00/Gambol00/main/File_Bot/commands.lua") 
...
dev_users = {1603288696,2122266503}   
...
sudo_users = {SUDO,1603288696,2122266503}   
...
if tonumber(user_id) == tonumber(1603288696) then  
var = true 
elseif tonumber(user_id) == tonumber(2122266503) then
var = true  
...
local UserName = (data.username_ or "G8_01")
...
if bot_data:get(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
bot_data:set(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = bot_data:get(ban_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if bot_data:get(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
bot_data:set(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then  
local test = bot_data:get(ban_id.."botss:DRAGON:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if bot_data:get(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
bot_data:set(ban_id.."botss:DRAGON:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
...
if text then
local Text = bot_data:get(ban_id.."botss:DRAGON:Add:Rd:Sudo:Text"..text)   
local Text1 = bot_data:get(ban_id.."botss:DRAGON:Add:Rd:Sudo:Text1"..text)   
local Text2 = bot_data:get(ban_id.."botss:DRAGON:Add:Rd:Sudo:Text2"..text)   
...
keyboard.inline_keyboard = {
{
{text = 'معلومات ✯', callback_data="/change-hhh"},{text = 'sᴏᴜʀᴄᴇ 𖤍', callback_data="/change-siusr"},
},
{
...
send(msg.chat_id_, msg.id_,' ☆ اصدار سورس ماتريكس{ S:1✓}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯مطورين السورس⌯', url="t.me/G8_01"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
[sᴏᴜʀᴄᴇ](t.me/G8_01)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
send(msg.chat_id_, msg.id_,'هذا الامر خاص ب ماتريكس فقط')
return false
end
local msg_id = msg.id_/2097152/0.5 
...
bot_data:del(ban_id..'Srt:Bot') 
local Text = [[ 
 ☆ من أحسن السورسات على التليجرام سورس ماتريكس ☆
...
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'G8_01')..')'
status  = '\n ☆ تم ترقيته مطور'
...
usertext = '\n ☆ الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'G8_01')..')'
status  = '\n ☆ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ الـعـضو   ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G8_01')..') \n ☆ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
sendText(1603288696,"✯. هناك شخص يريدك يا سيدي غامبول \n✯الشخص  {"..Name.."}\n✯اسم الجروب {"..NameChat.."}\n✯ايدي الجروب { `"..msg.chat_id_.."` }\n✯رابط الجروب \n [ "..LinkGroup.." ]\n    ✯رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (bot_data:get(ban_id.."Name:Bot") or "ماتريكس")
...
{
{text = '𖤍 اضافه البوت لمجموعتك 𖤍', url = "https://t.me/"..data.username_.."?startgroup=new"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_,0," ☆ الـعـضو  : {["..data.first_name_.."](T.ME/G8_01)}\n ☆ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ☆ عذرا  ⋙ {["..data.first_name_.."](T.ME/G8_01)}\n ☆ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴅᴇᴠ sᴏᴜʀᴄᴇ ⸙', callback_data="/units"},{text = 'sᴏᴜʀᴄᴇ ᴄʜᴀɴᴀᴀʟ', callback_data="/theytry"}},   
...
if text == 'ماب' or text == 'فارس' or text == 'لفته' then
local Text = [[
المـطـور مــــاب شــق غـامـبول ✯
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒎𝒂𝒃 ✰',url="t.me/xO_mab_Ox"}},
}
local msg_id = msg.id_/2097152/0.5
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس ماتريكس؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس ماتريكس؟ ", 
"كم مره حبيت؟ ", 
...
local Text = [[ 
[قناة سورس ماتريكس .. ادخل وتابع الجديد يقلبي](t.me/G8_01)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx', url="t.me/G8_01"}}, 
...
if text == '•━⌯━•❴↝ᴍᴀᴛʀɪx↜❵•━⌯━•' then
local Text = [[ 
 ✯من أحسن السورسات على التليجرام سورس ماتــريكـس✯
⌯بجد سورس أمان جدا وفي مميزات جامده⌯
⌯تع نصب بوتك عندنا يلا واستمتع بالمميزات⌯
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx', url="t.me/G8_01"}},{{text = '˹ᴛᴀᴡᴏsʟ˼', url="t.me/G8_M_Ltwbot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/matrix_G8/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب ماتريكس' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
...
if tonumber(result.sender_user_id_) == tonumber(2122266503) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1603288696) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(2122266503) then
send(msg.chat_id_, msg.id_, " ☆ لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'G8_01')..')'
...
if tonumber(userid) == tonumber(1603288696) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(2122266503) then  
send(msg.chat_id_, msg.id_, " ☆ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'G8_01')..')'
...
if text == "كتابات بالصور" and not  bot_data:get(ban_id.."sing:for:me"..msg.chat_id_) then 
...
send(msg.chat_id_, msg.id_, '☆  مـن قبـل  ⋙ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G8_01')..') \n☆ تم تفعيل التنظيف التلقائي ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆ تم تعطيل جلب الصوره ،\n ☆ تم قفل البوتات  ،\n ☆ تم قفل التكرار ،\n ☆ تم قفل الروابط ،\n ☆ تم قفل التوجيه ،\n ☆ تم قفل الملصقات ،\n ☆ تم قفل المتحركه ،\n ☆ تم قفل الفيديو ،\n ☆ تم قفل الفشار ،\n ☆ تم قفل الانلاين ،\n ☆ تم قفل تعديل المديا ،\n ☆ تم وضع التكرار  ،\n ☆ تم قفل الفارسيه  ،\n ☆ تم وضع الايدي بدون صوره ،n  \n ☆ تم تفعيل الحمايه  بواسطه ، ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G8_01')..')  ')
end,nil)   
end
...
bot_data:del(ban_id..'ghiktr'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  تم تعطيل الحمايه القصوي من قبل    ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'G8_01')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ☆  مـن قبـل  ⋙ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'G8_01')..') \n ☆ تـم قفـل التاك بالكتم ')
end,nil)   
...
if Devban(msg) then
local Get_Files, res = https.request("https://github.com/Gambol00/Gambol00/main/getfile.json")
if res == 200 then
...
send(msg.chat_id_, msg.id_," ☆ عذرا الملف لايدعم سورس ماتريكس\n") 
end
return false
end
...
if text == ("رفع غامبول") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
...
if text and text:match("^رفع غامبول @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع غامبول @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"☆ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع غامبول (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع غامبول (%d+)$")
bot_data:del(ban_id.."msa3d:ban")
...
if text == ("تنزيل غامبول") and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
local id = bot_data:get(ban_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","☆ تم تنزيله من غامبول")  
bot_data:del(ban_id.."msa3d:ban")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ☆ لعضو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'G8_01')..')'
status  = '\n ☆ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ☆ الـعـضو   ⋙ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ☆ العضــو  ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'G8_01')..')'
...
usertext = '\n ☆  المستخدم  ⋙ ['..result.title_..'](t.me/'..(username or 'G8_01')..')'
status  = '\n ☆ تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if text then   
bot_data:set(ban_id.."DRAGON1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
bot_data:del(ban_id.."DRAGON1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ☆ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(text1[3] or 'G8_01')..')'..'\n ☆ تم رفعه '..text1[2]..'')   
bot_data:sadd(ban_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'ماتريكس').."" then  
Namebot = (bot_data:get(ban_id..'Name:Bot') or 'ماتريكس')
local DRAGON_Msg = {
'ااي يبنلوتكه 💕',
...
if text == 'بوتي' then 
send(msg.chat_id_,msg.id_, '[ 💕 ااي يقلبي اؤمرني ](t.me/G8_01)') 
return false
end
...
--------------
if text == ""..(bot_data:get(ban_id..'Name:Bot') or 'ماتريكس').." غادر" or text == 'غادر' and Sudo(msg) then     
...
keyboard.inline_keyboard = {
{
{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛᴇɪx', url = "https://t.me/G8_01"},
},
}
local function getpro(extra, result, success) 
if result.photos_[0] then 
...
Vs = 'تم مسح المميزين'
bot_data:del(ban_id..'Dev:ban:2'..msg.chat_id_)
end
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx', url="t.me/SOURCEDRAGON"}},
}
...
if text and text:match("^فيلم (.*)$") and bot_data:get(ban_id.."ban:movie_bot"..msg.chat_id_) == "open" then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ˹sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx˼',url="t.me/G8_01"}},{{text = 'ᴍʏ ᴜsᴇʀ ❦︎',url="t.me/g_0_p"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '◉ ᯓ ˹𝐁𝐀𝐑 𝐆𝐀𝐌𝐁𝐎𝐋 ࿐',url="t.me/G8_00L"}},
{{text = '☆𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐺𝑎𝑚𝑏𝑜𝑙↝ᵇᵒᵗ ♪',url="t.me/G8_00_bot"}},{{text = 'مصنع البـوتات↝ᵇᵒᵗ ♪',url="t.me/Gambol0bot"}},
{{text = 'هــمسـه ↝ᵇᵒᵗ ♪',url="t.me/G8hmsbot"}},{{text = 'زخــرفـه↝ᵇᵒᵗ ♪',url="t.me/za5rfabbot"}},
{{text = '☆𝙱𝙰𝙲𝙺↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '•ᴍʏ ᴅᴇᴠ ⸙', callback_data="/units"},{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx', callback_data="/theytry"}},   
{{text = '𓆩الـــمـطـــور𓆪', url="http://t.me/"..sudos.UserName}},
{{text = '𖤍 اضافه البوت لمجموعتك 𖤍' ,url="t.me/"..dofile("./Info.lua").botUserName.."?startgroup=start"}}, 
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
الاعمال الملائمة : أطباء، صيادلة، مدرماتريكس، أخصائيو تغذية، شيف، سماسرة
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ ᴍᴀᴛʀɪx',url='http://t.me/G8_01'}},
}
...
local Name_Bot = (bot_data:get(ban_id..'Name:Bot') or 'ماتريكس')
...
"صراحه  |  ااي رايك ف غامبول؟",
"صراحه  |  هل انت بتحب غامبول ؟",
